...
function About(props) {
  ...
  return (
    <>
          ...
          <div className="container px-5 py-3 mt-2 flex flex-row">
            <div className="lg:w-4/6 mx-auto">
              <div className="flex flex-col sm:flex-row mt-5">
                <div
                  className="sm:w-1/3 text-center sm:pr-8 sm:py-7"
                  data-aos="fade-in"
                >
                ...
                >
                  ...
                  >
                    Welcome to my portfolio! I'm a dedicated developer with
                    proficiency in the MERN stack, C, and C++. I've honed my
                    skills in crafting dynamic web applications using MongoDB,
                    Express.js, React, and Node.js. Recently, I've ventured into
                    the captivating realm of machine learning, driven by a keen
                    interest in exploring its diverse applications. My
                    commitment to perpetual learning fuels my journey, and I'm
                    excited about the endless possibilities that machine
                    learning presents. As I delve into the world of machine
                    learning, I am eager to apply my programming skills to
                  ...
                  >
                    ...
                    <button
                      class="rounded-lg relative w-36 h-10 cursor-pointer flex items-center border border-green-500 bg-teal-700 group hover:bg-teal-700 active:bg-teal-700 active:border-teal-700"
                      onClick={handleDownload}
                    >
                      <span class="text-white font-semibold ml-8 transform group-hover:translate-x-20 transition-all duration-300">
                        Resume
                      </span>
                      <span class="absolute right-0 h-full w-10 rounded-lg bg-teal-700 flex items-center justify-center transform group-hover:translate-x-0 group-hover:w-full transition-all duration-500">
                        <div className="flex items-center">
                          <BsDownload className="mr-2 font-semibold text-white" />
                        </div>
      ...
      <div
        className="flex justify-center pb-5 skills-spacing"
        data-aos="fade-up"
