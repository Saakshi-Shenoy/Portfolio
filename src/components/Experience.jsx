        ...
        <VerticalTimeline>
          ...
          >
            ...
            <p className="text-black">
              Development of an Intent-based LLM for the purpose of Service
              Orchestration. <br />
            </p>
            <p className="text-gray-500 font-semibold lg:hidden md:hidden">
              April 2024 - Present
            </p>
          </VerticalTimelineElement>
          ...
          >
            ...
            <p className="text-black">
              Development of clean and robust websites to provide information
              and facilitate the registration to events organised by the
